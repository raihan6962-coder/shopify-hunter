...
def check_store_target(base_url, session):
    ...
    ২. Checkout পেজের HTML কোড স্ক্যান করবে।
    ৩. যদি card, visa, paypal ইত্যাদি থাকে -> REJECT.
    ৪. যদি না থাকে -> ACCEPT (Lead).
    """
...
def _run():
    ...
    log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", "INFO")
    log("🚀 PHASE 1 — NICHE SEARCH & HTML CHECKOUT ANALYSIS", "SUCCESS")
